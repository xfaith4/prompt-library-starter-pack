---
description: Require a post-implementation stabilization and regression review before completion. Use when a feature looks correct but should not yet be considered complete.
---
